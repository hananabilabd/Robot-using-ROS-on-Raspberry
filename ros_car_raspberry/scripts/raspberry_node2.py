...
class Main():
    def __init__(self, parent=None):
        ...
        self.pub = rospy.Publisher('/robot/ultrasound_sensor_status', String, queue_size=10)
    ...
    def callback(self,msg):
        rospy.loginfo("Received from laptop node 2: %s ",msg.data)
